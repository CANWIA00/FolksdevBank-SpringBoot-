package com.folksdev.bank.folksdevbank;

import com.folksdev.bank.folksdevbank.model.*;
import com.folksdev.bank.folksdevbank.repository.AccountRepository;
import com.folksdev.bank.folksdevbank.repository.AddressRepository;
...
public class FolksdevbankApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Customer c1 = Customer.builder()
				.id("1234568")
				.name("Cagri")
				.address(Address.builder().city(City.ISTANBUL).postcode("456312").addressDetailss("bu bir adrestir").build())
				.city(City.ISTANBUL)
				.dateOfBirth(1988)
				.build();
		...
		Customer c2 = Customer.builder()
				...
				.name("Semih")
				.city(City.MANISA)
				.address(Address.builder().city(City.MANISA).postcode("456312").addressDetailss("bu bir adrestir 2").build())
				.dateOfBirth(2000)
				.build();
		...
		Customer c3 = Customer.builder()
				...
				.name("untpleax")
				.city(City.IZMIR)
				.address(Address.builder().city(City.IZMIR).postcode("456312").addressDetailss("bu bir adrestir 3").build())
				.dateOfBirth(2005)
				.build();
